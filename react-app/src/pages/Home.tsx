...
function Home() {
  ...
  return (
    ...
    <SEO 
      title="Главная"
      description="AllergyDetect - определение ингредиентов по фотографии продуктов, выявление аллергенов и сигнализирование о медицинских противопоказаниях. Безопасное хранение данных и персонализированные рекомендации."
